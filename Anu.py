...
\033[1;91m☞ Auther     : AND BRAND
\033[1;92m☞ WhatsApp   : 03365115433
\033[1;95m☞ facebook   : https://www.facebook.com/idrees.ejaz.7
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 0336511544✓')
	    psb('WellCome To anu dada')
	    psb('Congratulations B4_BALOCH Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ anu')
	    psb('🔓Password ☆ dada')
	    psb('clonning master anu brand ✓')
